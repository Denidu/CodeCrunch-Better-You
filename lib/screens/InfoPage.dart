        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const Text(
                "BetterYou also includes instructional images to demonstrate proper form and technique for each exercise, as well as tips on how to modify exercises to accommodate individual needs and limitations.",
                style: TextStyle(
                  fontSize: 13,
                  color: Colors.black,
                  fontFamily: "Poppins",
              ...
              const SizedBox(height: 10),
              const Text(
                "Overall, BetterYou provides a personalized and adaptable fitness plan to improve physical health and fitness, enhance mobility, and boost overall quality of life for individuals with physical disabilities.",
                style: TextStyle(
                  fontSize: 13,
                  color: Colors.black,
                  fontFamily: "Poppins",
